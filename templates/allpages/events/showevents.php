...
$events=$db->SelectAll("{$event_table}");
 ?>
          ...
          <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><a href="<?=$base_url;?>addevents" class="link">Add Events</a></li>
              </ol>
            </nav>
          </div>
          <div class="card">
            <div class="card-body">
              <h4 class="card-title">show Events</h4>
              <div class="row">
                <div class="col-12">
                      ...
                      <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                              ...
                              <a href="#" data-did="<?=$data->id?>" class="link btn btn-outline-primary delete-events"><i class="fa-solid fa-trash"></i></a>
                            </td>
                        </tr>
                        <?php } ?>
