            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="cmxform" name="addmember" id="signupForm" method="post" action="database/actions/pages/insert.php" enctype="multipart/form-data" onsubmit="return validateForm()">
                    <fieldset>
                    ...
                    <div class="form-group col-6">
                        ...
                        <textarea name="meta_title" id="meta_description1"  class="form-control" rows="8" data-gramm="false" wt-ignore-input="true" data-quillbot-element="IMpuXxEePO7giRtfkYfZ2"></textarea>
                        </div>
                        <div class="form-group col-6">
                        <label for="firstname">Meta Discription</label>
                        <textarea name="meta_description" id="meta_description1"  class="form-control" rows="8" data-gramm="false" wt-ignore-input="true" data-quillbot-element="IMpuXxEePO7giRtfkYfZ2"></textarea>
                        </div>
                    </div>
                    <div class="col-lg-4  grid-margin stretch-card mt-3">
                        ...
                        <div class="card-body">
                          ...
                          <input type="file" name="pageimage" class="dropify" Required />
                        </div>
                      </div>
                    </div>
